...
```bash
python tests/smoke_test_provider.py
```

This will load `.env`, create the configured provider, and send a single test prompt.
...
# Day-3-Lab-Chatbot-vs-react-agent-C401-B1
